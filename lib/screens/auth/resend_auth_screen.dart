...
import 'package:module_complete/screens/auth/controller/auth_screen_controller.dart';
...
class ResendAuthScreen extends StatelessWidget {
  final String page;
  final String phone;
  const ResendAuthScreen({Key? key, required this.page, required this.phone})
      : super(key: key);
                            ...
                            Center(
                              child: PinCodeTextField(
                                ...
                                controller: authController
                                    .resendOtpTextController.value,
                                onCompleted: (v) {
                                  log("Completed");
                                },
                                onChanged: (value) {
                                  authController.resendvalue.value;
                                },
